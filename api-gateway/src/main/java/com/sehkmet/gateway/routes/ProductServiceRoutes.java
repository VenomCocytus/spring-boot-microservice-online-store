...
public class ProductServiceRoutes {
    ...
    public RouterFunction<ServerResponse> productServiceApiRoute() {
        ...
        return GatewayRouterFunctions.route("product_service")
                ...
                .route(RequestPredicates.POST("/api/product/create"), HandlerFunctions.http(productServiceUrl + "/create"))
                .route(RequestPredicates.DELETE("/api/product/*"), HandlerFunctions.http(productServiceUrl + "/*"))
